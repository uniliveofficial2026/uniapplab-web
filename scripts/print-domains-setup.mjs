...
console.log('');
console.log('Vercel deploy (app + apex + www on ONE project)');
...
console.log('  5. Domains → add app.uniapplab.com, uniapplab.com, www.uniapplab.com');
console.log('');
console.log('Cloudflare DNS (nameservers must match your registrar setup)');
console.log('  If uniapplab.com uses Cloudflare NS, set records in Cloudflare (not Vercel DNS):');
console.log('    app  CNAME  cname.vercel-dns.com   (or Vercel project target)');
console.log('    www  CNAME  cname.vercel-dns.com');
console.log('    @    A      76.76.21.21  +  76.223.126.88  (Vercel apex) OR CNAME flatten to Vercel');
console.log('  Use DNS only (grey cloud) while debugging. Orange-cloud proxy to a dead');
console.log('  Render/origin causes: upstream connect error … delayed connect error: 111');
console.log('  All three hosts must point at the SAME Vercel project (uniapplab-web-instacollab).');
console.log('');
