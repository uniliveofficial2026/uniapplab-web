...
console.log("");
console.log("6) HTTP issue creation (optional — requires bearer secret)");
console.log(
  "   Only set this if an internal service will POST /api/linear/issues:",
);
console.log("");
console.log("   LINEAR_ISSUE_CREATE_SECRET=<long random secret>");
console.log("");
console.log("7) Sync env to Vercel + Fly");
...
console.log(
  "  Failed handoff tasks auto-create Linear issues (priority: High)",
);
