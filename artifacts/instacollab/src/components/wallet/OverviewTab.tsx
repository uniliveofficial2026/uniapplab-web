          ...
          <div className="h-44 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData} margin={{ top: 5, right: 5, left: -20, bottom: 5 }}>
                <defs>
                  <linearGradient id="walletOverviewValue" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor={chartTheme.seriesFillTop} stopOpacity={1} />
                    <stop offset="95%" stopColor={chartTheme.seriesFillBottom} stopOpacity={1} />
                  </linearGradient>
                </defs>
