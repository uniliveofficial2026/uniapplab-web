...
export function ShareModal({
  ...
  const handleSend = () => {
    sendShareToUsers(db, selectedUserIds, {
      kind,
      shareUrl,
      shareText,
      itemTitle,
  ...
  return createPortal(
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4" data-app-overlay-root>
          <div
          ...
          >
            ...
            <div className="flex items-center gap-2 p-2.5 bg-secondary rounded-lg border border-border">
              ...
              <div className="flex-1 truncate text-xs font-medium text-muted-foreground">{shareUrl}</div>
              <button
