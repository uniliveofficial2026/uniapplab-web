...
import { extractAudioCoverFromFile } from '../../lib/mediaCoverArt';
import { useToast } from '../../lib/ToastContext';
import { BackgroundAudioPlayer } from './BackgroundAudioPlayer';
import { PLAYBACK_PRIORITY } from '../../lib/playbackAudio';

export type CustomAudioSelection = { url: string; name: string; coverUrl?: string } | null;
...
export function AudioTrackPicker({
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const coverUrl = await extractAudioCoverFromFile(file);
      onCustomAudioChange({ url, name: file.name, coverUrl });
