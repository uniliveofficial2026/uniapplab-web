 ...
 * Full-bleed edge-to-edge with safe content gutters.
 */
export function ScreenFallback() {
  ...
  return (
    <div
      className="app-screen app-screen--immersive flex flex-1 min-h-0 flex-col w-full bg-[color:var(--color-unilives-background)] text-[color:var(--color-unilives-text)]"
      role="status"
      aria-live="polite"
      aria-label={offline ? 'Offline — showing saved layout' : 'Loading screen'}
    >
      <div className="flex items-center gap-3 app-content-gutter py-3 border-b border-[color:var(--color-unilives-border)] app-chrome-safe-top">
      ...
      <div className="flex-1 space-y-3 app-content-gutter py-4 app-chrome-safe-bottom">
