 ...
 */
import { automationFromSettings } from './automationControls';
...
const AUTOPILOT_THROTTLE_MS = 60_000;

function throttleMs(): number {
  return automationFromSettings(db.settings).autopilot ? AUTOPILOT_THROTTLE_MS : THROTTLE_MS;
}
