          ...
          <div className="h-44 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={getHistoricalChartData(selectedAsset)} margin={{ top: 5, right: 5, left: -20, bottom: 5 }}>
                ...
                <YAxis stroke="hsla(var(--border) / 0.6)" fontSize={10} fontWeight="600" domain={['auto', 'auto']} />
                <Tooltip 
                  contentStyle={{ 
                ...
                />
                <Area type="monotone" dataKey="value" stroke={assetDetails.color} strokeWidth={2.5} fillOpacity={1} fill="url(#cryptoGrad)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
